package cn.wode490390.nukkit.ompop.populator;
...
import cn.wode490390.nukkit.ompop.OceanMonumentPlugin;
import cn.wode490390.nukkit.ompop.math.BoundingBox;
import cn.wode490390.nukkit.ompop.scheduler.CallbackableChunkGenerationTask;
import cn.wode490390.nukkit.ompop.structure.OceanMonumentPieces;
import cn.wode490390.nukkit.ompop.structure.StructureStart;
...
public class PopulatorOceanMonument extends Populator {
    ...
    public void place(ChunkManager level, int startX, int startZ, FullChunk chunk) {
        ...
        if (start.isValid()) { //TODO: serialize nbt
            ...
            OceanMonumentPlugin.debug(this.getClass().getSimpleName(), chunkX << 4, 63, chunkZ << 4);
        }
    }
    ...
    public static void init() {
        ...
        WATER_BIOMES[47] = DEEP_OCEAN_BIOMES[47] = true; //DEEP_WARM_OCEAN
        WATER_BIOMES[48] = DEEP_OCEAN_BIOMES[48] = true; //DEEP_LUKEWARM_OCEAN
        WATER_BIOMES[49] = DEEP_OCEAN_BIOMES[49] = true; //DEEP_COLD_OCEAN
        WATER_BIOMES[50] = DEEP_OCEAN_BIOMES[50] = true; //DEEP_FROZEN_OCEAN
        // Rivers
